    ...
    <main className="min-h-screen bg-[#1E1F28] w-full">
      <section className="py-16 px-24">
        <header className="flex justify-between items-center mb-9">
          ...
          <button className="flex gap-2 items-center rounded justify-center px-6 py-3 text-white  shadow bg-gradient-to-r from-[#8323FF] to-[#FF2DAF] ">
            ...
            FILMS.map((film) => (
              <div key={film.id} className="flex flex-col gap-3">
                <div className="flex justify-between">
                  <h5 className="text-white font-semibold text-2xl">{film.title}</h5>
